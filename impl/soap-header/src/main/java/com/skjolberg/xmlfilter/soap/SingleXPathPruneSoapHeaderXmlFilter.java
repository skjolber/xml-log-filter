 ...
 *
 */
public class SingleXPathPruneSoapHeaderXmlFilter extends AbstractSingleXPathSoapHeaderXmlFilter {

	public SingleXPathPruneSoapHeaderXmlFilter(boolean declaration, String expression, int filterMatches) {
		super(declaration, null, -1, -1, expression, FilterType.PRUNE, filterMatches);
	}
