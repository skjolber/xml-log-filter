...
/**
 * 
 * XML indentation filter with support for a single anonymize or prune XPath-like expression.
 * 
 * @author Thomas Rorvik Skjolberg
 *
 */

public class SingleXPathXmlIndentationFilter extends SingleCharArrayXPathFilter {

	public SingleXPathXmlIndentationFilter(boolean declaration, String expression, FilterType type, Indent indent) {
		super(declaration, indent, -1, -1, expression, type);
	}
