...
/**
 * 
 * XML indentation filter with support for multiple anonymize and prune XPath-like expressions.
 * 
 * @author Thomas Rorvik Skjolberg
 *
 */

public class MultiXPathXmlIndentationFilter extends MultiCharArrayXPathFilter {

	public MultiXPathXmlIndentationFilter(boolean declaration, String[] anonymizes, String[] prunes, Indent indent) {
		super(declaration, -1, -1, anonymizes, prunes, indent);
	}
	...
	public String toString() {
		return "MultiFilterPlainPrettyPrinter [" 
