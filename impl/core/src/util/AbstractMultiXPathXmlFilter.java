...
public abstract class AbstractMultiXPathXmlFilter extends AbstractXPathXmlFilter {
	...
	public AbstractMultiXPathXmlFilter(boolean declaration, Indent indentation, String[] anonymizes, String[] prunes) {
		this(declaration, indentation, Integer.MAX_VALUE, Integer.MAX_VALUE, anonymizes, prunes);
	}

	public AbstractMultiXPathXmlFilter(boolean declaration, Indent indentation, int maxTextNodeLength, int maxCDATANodeLength, String[] anonymizes, String[] prunes) {
	...
	protected int matchAttributeFilter(final char[] chars, int offset, int length, final int[] attributeMatches, Filter filter, int sourceStart, int level) {
