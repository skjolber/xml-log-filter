...
import static com.skjolberg.xmlfilter.filter.XPathExpressions.PASSTHROUGH_XPATH_ATTRIBUTE;
...
public class SingleXPathFilterTest {
	...
	private class DefaultXPathXmlFilter extends SingleXPathFilter {
