...
public abstract class MultiXPathFilter extends AbstractMultiXPathFilter {
	...
	public MultiXPathFilter(boolean declaration, int maxTextNodeLength, int maxCDATANodeLength, String[] anonymizes, String[] prunes, Indent indent) {
